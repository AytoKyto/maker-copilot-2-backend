...
// src/Entity/ViewBenefitMonthCanal.php
...
#[ORM\Table(name: "view_benefit_month_canal")]
#[ApiResource(
...
#[ApiFilter(SearchFilter::class, properties: ['canal_id' => 'exact', 'month' => 'exact', 'years' => 'exact', 'user_id' => 'exact'])]


class ViewBenefitMonthCanal
{
