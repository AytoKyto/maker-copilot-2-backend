...
// src/Entity/ViewBestProductSalesMonthClient.php
...
#[ApiFilter(SearchFilter::class, properties: ['product_id' => 'exact','client_id' => 'exact', 'month' => 'exact', 'years' => 'exact', 'user_id' => 'exact'])]
...
class ViewBestProductSalesMonthClient
{
